...
# Load pre-trained COVID-19 model
model = load_model("covid_model.h5")

# Define classes
classes = {0: "COVID-19", 1: "Normal", 2: "Pneumonia"}
...
def predict():
    if request.method == "POST":
        ...
        # Convert image to RGB (3-channel format)
        ...
        return render_template(
            "predict.html", image=base64.b64encode(content).decode(), result=result
        )
